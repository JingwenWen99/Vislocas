...
class TransformerClassifier(Module):
    def __init__(self,
        ...
        self.fc = Linear(embedding_dim, num_classes) if num_classes > 0 else nn.Identity()
        # self.fc = nn.Sequential(
        #     nn.Linear(embedding_dim, num_classes * head_ratio),
        #     nn.LayerNorm(num_classes * head_ratio),
        #     nn.GELU(),
        #     nn.Linear(num_classes * head_ratio, num_classes)
