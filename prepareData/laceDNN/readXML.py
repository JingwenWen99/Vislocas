...
version = 19
dataDir = "data/v%d/" % version
# imageDir = "E:/data/IHC/"

xmlPath = dataDir + "proteinatlas_v%d.xml" % version
...
def fast_iter(context, func):
    ...
    for event, elem in context:
        ...
        tissueUrl, annotation = func(elem)
...
def process_element(elem):
    ...
    for antibody in elem.findall("antibody"):
        ...
        if normalTissue:
            reliability_verification = normalTissue.find("verification").text if normalTissue.find("verification") else None
