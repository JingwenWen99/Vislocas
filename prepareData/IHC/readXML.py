...
def fast_iter(context, func):
    ...
    f1 = open(dataDir + "IHC_expressionLevel.csv", "w", encoding="utf-8", newline="")
    ...
    f2 = open(dataDir + "tissueUrl.csv", "w", encoding="utf-8", newline="")
    ...
    f3 = open(dataDir + "pathologyUrl.csv", "w", encoding="utf-8", newline="")
    ...
    f4 = open(dataDir + "annotations.csv", "w", encoding="utf-8", newline="")
